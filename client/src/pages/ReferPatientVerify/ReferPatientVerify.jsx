...
const ReferPatientVerify = () => {
  ...
  return (
    <>
      {location ? <>{!ShowOtpInput ? <div className='flex h-screen items-center justify-center my-0 bg-[#E9ECEF] p-10'>
        <div className='w-full sm:w-[60%] py-10 flex flex-col md:justify-center items-center bg-white rounded-xl'>
          <h1 className='text-[#081b2b] font-bold text-center text-4xl mb-5'>Rishtpusht Contact Form</h1>
          <form onSubmit={onSubmithandler} className='flex flex-col gap-4 w-[80%] md:w-[250px]'>
            ...
            <button type="submit" className="p-2 my-2 cursor-pointer bg-[#3e454b] border-2 border-solid border-[#3e454b] text-white w-[100%] text-lg rounded-md">{submitLoad?<div className="animate-spin inline-block size-6 border-[3px] border-current border-t-transparent text-white rounded-full dark:text-blue-500" role="status" aria-label="loading">
